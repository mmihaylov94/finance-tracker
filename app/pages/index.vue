<template>
  <section class="flex items-center justify-between mb-10">
    ...
    <div>
      <USelect :items="transactionViewOptions" v-model="selectedView" ignore-filter></USelect>
    </div>
  </section>
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
    ...
    <Trend color="green" title="Investments" :amount="4000" :last-amount="4100" :loading="pending" />
    <Trend color="red" title="Savings" :amount="4000" :last-amount="3000" :loading="pending" />
  </section>
  <section class="flex justify-between mb-10">
    ...
    <div>
      <TransactionModal v-model="isOpen" @saved="refresh()"></TransactionModal>
...
const { user } = await useGetUserDetais();
